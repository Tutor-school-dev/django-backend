...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        learner = Learner.objects.create(
            id=learner_id,
            name="Test Student",
            primary_contact="+919176543210",
            email="ttteststudent@example.com",
            board="CBSE",
            guardian_name="Test Parent",
            guardian_email="ttestparent@example.com",
            educationLevel="12",
            budget=1000.0,
        ...
        for tutor_data in tutors_data:
            ...
            tutor = Teacher.objects.create(
                ...
                primary_contact=f"+9191765432{len(created_tutors)}0",
                email=f"tutors{len(created_tutors)}@example.com",
